...
void wire_get_user_communication_specifiers(int64_t port_, struct wire_uint_8_list *user_config);

void wire_get_user_device_definitions(int64_t port_, struct wire_uint_8_list *user_config);
