...
abstract class RustLibApiImplPlatform extends BaseApiImpl<RustLibWire> {
  ...
  JSAny cst_encode_engine_options_external(EngineOptionsExternal raw) {
    ...
    return [
      ...
      cst_encode_bool(raw.useSimulatedDevices),
      ...
      cst_encode_bool(raw.emitOutputObservations),
    ].jsify()!;
  }
  ...
  @protected
  JSAny cst_encode_exposed_simulated_device_archetype(
    ExposedSimulatedDeviceArchetype raw,
  ) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return [
      cst_encode_String(raw.identifier),
  ...
  @protected
  JSAny cst_encode_exposed_simulated_device_config_entry(
    ExposedSimulatedDeviceConfigEntry raw,
  ) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return [
      cst_encode_String(raw.identifier),
  ...
  @protected
  JSAny cst_encode_exposed_simulated_device_feature_summary(
    ExposedSimulatedDeviceFeatureSummary raw,
  ) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return [
      cst_encode_String(raw.description),
      cst_encode_String(raw.outputType),
  ...
  @protected
  JSAny cst_encode_list_exposed_simulated_device_archetype(
    List<ExposedSimulatedDeviceArchetype> raw,
  ) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return raw
        .map(cst_encode_exposed_simulated_device_archetype)
        .toList()
        .jsify()!;
  }

  @protected
  JSAny cst_encode_list_exposed_simulated_device_config_entry(
    List<ExposedSimulatedDeviceConfigEntry> raw,
  ) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return raw
        .map(cst_encode_exposed_simulated_device_config_entry)
        .toList()
        .jsify()!;
  }

  @protected
  JSAny cst_encode_list_exposed_simulated_device_feature_summary(
    List<ExposedSimulatedDeviceFeatureSummary> raw,
  ) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return raw
        .map(cst_encode_exposed_simulated_device_feature_summary)
        .toList()
        .jsify()!;
  }

  @protected
  JSAny cst_encode_list_input_type(List<InputType> raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return raw.map(cst_encode_input_type).toList().jsify()!;
  }
...
class RustLibWire implements BaseWire {
  ...
  void wire__crate__api__simulated_devices__add_simulated_device(
    ...
    String identifier,
    String? display_name,
  ) => wasmModule.wire__crate__api__simulated_devices__add_simulated_device(
    port_,
    identifier,
    display_name,
  );
  ...
  void wire__crate__api__simulated_devices__get_user_simulated_devices(
    NativePortType port_,
      ...
      .wire__crate__api__simulated_devices__get_user_simulated_devices(port_);
  ...
  void wire__crate__api__simulated_devices__remove_simulated_device(
    NativePortType port_,
    String address,
  ) => wasmModule.wire__crate__api__simulated_devices__remove_simulated_device(
    port_,
    address,
  );
...
extension type RustLibWasmModule._(JSObject _) implements JSObject {
  ...
  external void wire__crate__api__simulated_devices__add_simulated_device(
    NativePortType port_,
    String identifier,
    String? display_name,
  );
  ...
  external void wire__crate__api__simulated_devices__get_user_simulated_devices(
    NativePortType port_,
  );
  ...
  external void wire__crate__api__simulated_devices__remove_simulated_device(
    NativePortType port_,
    String address,
  );
