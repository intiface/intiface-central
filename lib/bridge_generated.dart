...
abstract class IntifaceEngineFlutterBridge {
  ...
  Future<List<ExposedUserDeviceConfig>> getUserDeviceConfigs(
...
class IntifaceEngineFlutterBridgeImpl implements IntifaceEngineFlutterBridge {
  ...
  Future<List<ExposedUserDeviceConfig>> getUserDeviceConfigs(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      ...
      parseSuccessData: _wire2api_list_exposed_user_device_config,
...
class wire_UserConfigDeviceIdentifier extends ffi.Struct {
...
class wire_ExposedUserDeviceConfig extends ffi.Struct {
...
class wire_list_exposed_user_device_config extends ffi.Struct {
