...
class AppControlPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<EngineControlBloc, EngineControlState>(
        ...
        builder: (context, engineState) => BlocBuilder<
                IntifaceConfigurationCubit, IntifaceConfigurationState>(
                            ...
                            child: Padding(
                                ...
                                child: DropdownButton<String>(
                                  ...
                                  onChanged: engineState is EngineStoppedState
                                      ? (String? value) {
                                          configCubit.appMode = AppMode.values
                                              .firstWhere((element) {
                                            return element.name == value;
                                          }, orElse: () => AppMode.engine);
                                          logDebug(
                                              "Set appMode to ${configCubit.appMode.name}");
                                        }
                                      : null,
                                  items: modes
                                      .map((e) => e.name)
                                  ...
                                  dropdownColor: Colors
                                      .deepPurpleAccent, //dropdown background color
                                  underline: Container(), //remove underline
                                )))),
                    configCubit.appMode == AppMode.repeater
                        ? const RepeaterConfigWidget()
                        : const EngineConfigWidget()
                  ],
                ))));
  }
}
