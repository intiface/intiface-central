    ...
    return BlocBuilder(
        ...
        builder: (context, updateState) {
          return BlocBuilder<IntifaceConfigurationCubit, IntifaceConfigurationState>(
              ...
              builder: (context, state) => BlocBuilder<EngineControlBloc, EngineControlState>(
                        ...
                        children: [
                          ...
                          Visibility(
                            ...
                            child: TextButton.icon(
                                ...
                                style: ButtonStyle(
                                    foregroundColor: MaterialStateProperty.resolveWith((s) => Colors.green))),
                          ),
                          Visibility(
                            visible: false,
                            child: TextButton.icon(
                                ...
                                style: ButtonStyle(
                                    foregroundColor: MaterialStateProperty.resolveWith((s) => Colors.blue))),
                          )
                        ],
                      ),
