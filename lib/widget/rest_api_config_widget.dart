...
class RestApiConfigWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var restPortController = TextEditingController(text: configCubit.restLocalPort.toString());
    return Expanded(
      child: BlocBuilder<EngineControlBloc, EngineControlState>(
        ...
        builder: (context, engineState) {
          return BlocBuilder<IntifaceConfigurationCubit, IntifaceConfigurationState>(
            buildWhen: (previousState, currentState) => currentState is RestLocalPortState,
                        ...
                        showDialog(
                          ...
                          builder: (context) => AlertDialog(
                            ...
                            actions: <Widget>[
                              ...
                              TextButton(
                                onPressed: () {
                                  var newPort = int.tryParse(restPortController.text);
                                  if (newPort != null && newPort > 1024 && newPort < 65536) {
                                    cubit.restLocalPort = newPort;
                                  }
                                  Navigator.pop(context);
